...
const LogoutButton = () => {
  return (
    // The link will take user to `http://localhost:8080/auth/logout` which will delete the user server session and redirect user back to client-side app with the cookie invalidated
